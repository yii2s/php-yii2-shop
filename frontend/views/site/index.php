                ...
                <div class="panel-body">
                    <?php foreach((array)$hotGoods as $hot) { ?>
                        <div class="col-sm-6 col-md-3">
                            <div class="thumbnail">
                                <img src="<?= $hot['ad_img']; ?>" style="width: 240px;height: 240px" onerror='this.src="public/common/images/1.jpg"'
                                     alt="<?= $hot['name']; ?>">
                                <div class="caption">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php foreach((array)$bargainGoods as $bargain) { ?>
                        <div class="col-sm-6 col-md-3">
                            <div class="thumbnail">
                                <img src="<?= $bargain['ad_img']; ?>" style="width: 240px;height: 240px" onerror='this.src="public/common/images/1.jpg"'
                                     alt="<?= $bargain['name']; ?>">
                                <div class="caption">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php foreach((array)$newestGoods as $newest) { ?>
                        <div class="col-sm-6 col-md-3">
                            <div class="thumbnail">
                                <img src="<?= $newest['ad_img']; ?>" style="width: 240px;height: 240px" onerror='this.src="public/common/images/1.jpg"'
                                     alt="<?= $newest['name']; ?>">
                                <div class="caption">
