        ...
        <div class="goods-form" style="margin-top: 20px">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="base-info">
                    <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => '名称', 'value'=>'呵呵哒', 'style' => 'width:80%'])->label('商品名称:') ?>
                    <?= $form->field($model, 'goods_no')->textInput(['maxlength' => true, 'placeholder' => '000000', 'value'=>12, 'style' => 'width:20%'])->label('商品编号:') ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-1"><label class="control-label" for="goods-content">内容:</label></div>
                ...
                <div role="tabpanel" class="tab-pane" id="goods-imgs">
                    <div class="form-group">
                        <div class="col-sm-1"><label class="control-label" for="goods-ad-img">封面:</label></div>
                        <div class="col-sm-10">
