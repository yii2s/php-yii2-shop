 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'backend\module\permission\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        ...
        if ($this->navbar === null && Yii::$app instanceof \yii\web\Application) {
            $this->navbar = [
                ['label' => Yii::t('rbac-admin', '后台首页'), 'url' => ['default/index']],
                ['label' => Yii::t('rbac-admin', '商品首页'), 'url' => './index.php'],
                ['label' => Yii::t('rbac-admin', '商品列表'), 'url' => ['goods/list','cid' => 4]]
            ];
        }
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('backend\module\permission\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
