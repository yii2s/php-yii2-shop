...
$this->title = '后台管理';
?>
<?php $this->registerCssFile('./public/backend/skin/default/skin.css',['position'=>\yii\web\View::POS_HEAD])?>
        ...
        <ul>
            <li class="dropDown dropDown_click"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                <ul class="dropDown-menu radius box-shadow">
                    <li><a href="javascript:;" onclick="article_add('添加资讯','<?= Yii::$app->urlManager->createUrl(['article/add'])?>')"><i class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
                    <li><a href="javascript:;" onclick="picture_add('添加资讯','picture-add.html')"><i class="Hui-iconfont">&#xe613;</i> 图片</a></li>
                    <li><a href="javascript:;" onclick="product_add('添加资讯','<?= Yii::$app->urlManager->createUrl(['product/add'])?>')"><i class="Hui-iconfont">&#xe620;</i> 产品</a></li>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="<?= Yii::$app->urlManager->createUrl(['brand/add'])?>" href="javascript:void(0)">品牌管理</a></li>
                    <li><a _href="<?= Yii::$app->urlManager->createUrl(['categories/add'])?>" href="javascript:void(0)">分类管理</a></li>
                    <li><a _href="<?= Yii::$app->urlManager->createUrl(['attributes/add'])?>" href="javascript:void(0)">属性管理</a></li>
                    <li><a _href="<?= Yii::$app->urlManager->createUrl(['goods/list'])?>" href="javascript:void(0)">产品管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-page">
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a _href="<?= Yii::$app->urlManager->createUrl(['admin/role'])?>" href="javascript:void(0)">角色管理</a></li>
                    <li><a _href="<?= Yii::$app->urlManager->createUrl(['admin/permission'])?>" href="javascript:void(0)">权限管理</a></li>
                    <li><a _href="<?= Yii::$app->urlManager->createUrl(['admin/list'])?>" href="javascript:void(0)">管理员列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-tongji">
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active"><span title="我的桌面" data-href="<?= Yii::$app->urlManager->createUrl(['main/welcome']) ?>">我的桌面</span><em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="<?= Yii::$app->urlManager->createUrl(['main/welcome']) ?>"></iframe>
        </div>
    </div>
</section>
