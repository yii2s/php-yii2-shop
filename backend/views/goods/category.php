...
<table class="table">
	<tr>
		...
		<td class="va-t"><IFRAME ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="<?= Yii::$app->urlManager->createUrl(['product/add-category'])?>"></IFRAME></td>
	</tr>
</table>
