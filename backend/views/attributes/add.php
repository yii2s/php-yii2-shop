    ...
    <td class="va-t">
      ...
      <div class="pd-20">
        ...
        <div class="row cl">
          ...
          <div class="formControls col-5">
            <?= $form->field($model,'title')->textInput(['class'=>'input-text','placeholder'=>'属性名称'])->label(false) ?>
          </div>
          <div class="col-5"> </div>
        </div>
        <div class="row cl">
          ...
          <div class="formControls col-5">
            <?= $form->field($model,'values')->textarea(['rows'=>5,'cols'=>50,'placeholder'=>'多个属性值以逗号隔开（例如：黑色,红色,白色）'])->label(false)?>
          </div>
          <div class="col-5"> </div>
        </div>
        <div class="row cl">
          <label class="form-label col-2"><span class="c-red">*</span>输入类型：</label>
          <div class="formControls col-5">
            <?= $form->field($model, 'inputType')->dropDownList(['0'=>'输入框','1'=>'下拉','2'=>'单选','3'=>'多选'], ['style'=>'width:120px'])->label(false) ?>
          </div>
          <div class="col-5"> </div>
        </div>
        <br>
        <div class="row cl">
          ...
          <div class="formControls col-5">
            <?= Html::submitButton('Submit', ['class' => 'btn btn-primary radius']) ?>
          </div>
        </div>
