...
<?php $this->registerCssFile('./public/backend/lib/webuploader/0.1.5/webuploader.css',['position'=>\yii\web\View::POS_HEAD]) ?>
<div class="pd-20">
...
<?= Html::jsFile('public/backend/lib/webuploader/0.1.5/webuploader.min.js')?>
<?= Html::jsFile('public/backend/lib/ueditor/1.4.3/ueditor.config.js')?>
<?= Html::jsFile('public/backend/lib/ueditor/1.4.3/ueditor.all.min.js')?>
<?= Html::jsFile('public/backend/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js')?>
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: 'public/backend/lib/webuploader/0.1.5/Uploader.swf',
